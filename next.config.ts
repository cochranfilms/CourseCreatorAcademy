...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "img-src 'self' data: blob: https://image.mux.com https://firebasestorage.googleapis.com https://storage.googleapis.com https://*.firebasestorage.app https://lh3.googleusercontent.com",
      "media-src 'self' blob: https://stream.mux.com https://*.mux.com https://firebasestorage.googleapis.com https://storage.googleapis.com https://*.firebasestorage.app",
      "font-src 'self' data:",
      "connect-src 'self' https://api.mux.com https://stream.mux.com https://image.mux.com https://*.mux.com https://*.edgemv.mux.com https://inferred.litix.io https://litix.io https://js.stripe.com https://api.stripe.com https://firebasestorage.googleapis.com https://*.firebasestorage.app https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://firestore.googleapis.com https://www.googleapis.com https://www.google.com https://graph.facebook.com https://content-firebaseappcheck.googleapis.com",
